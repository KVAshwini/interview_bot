...
FULLSTACK = [
    ...
    ("cache invalidation", "How do you handle frontend cache invalidation?", ["How do you keep UI data fresh?", "How do query caches work?"], ["full stack", "cache", "invalidation", "frontend"]),
